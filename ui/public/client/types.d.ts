...
export declare enum ApplicationSourceKind {
...
/** Commit a Resource Sync. (alias: `commit`) */
 | {
    ...
    type: "RollbackClusterWorkload";
    params: RollbackClusterWorkload;
} | {
    type: "ScaleClusterWorkload";
    params: ScaleClusterWorkload;
} | {
    type: "CordonClusterNode";
    params: CordonClusterNode;
} | {
    type: "UncordonClusterNode";
    params: UncordonClusterNode;
} | {
    ...
    type: "BatchPlanTerraform";
    params: BatchPlanTerraform;
} | {
    type: "ApplyTerraform";
    params: ApplyTerraform;
} | {
    type: "BatchApplyTerraform";
    params: BatchApplyTerraform;
} | {
...
export type GetTerraformActionStateResponse = TerraformActionState;
...
export type GetTerraformResponse = Terraform;
...
export type ListFullTerraformsResponse = Terraform[];
...
export declare enum OrphanedObjectKind {
    Container = "Container",
...
export type ListTerraformsResponse = TerraformListItem[];
...
export type SearchClusterPodLogResponse = Log;
 ...
 * Response: [Update]
 */
export interface ApplyClusterObject {
    /** Id or name */
    cluster: string;
 ...
 */
export interface CopyTerraform {
...
export interface CordonClusterNode {
    /** Id or name */
    cluster: string;
    /** The node's name. */
    node: string;
 ...
 */
export interface DeleteTerraform {
 ...
 */
export interface DrainClusterNode {
    /** Id or name */
    cluster: string;
    /** The node's name. */
    node: string;
 ...
 */
export interface GetTerraformActionState {
    /** Id or name */
    terraform: string;
}
/**
 ...
 */
export interface GetTerraformsSummary {
}
/** Response for [GetTerraformsSummary] */
export interface GetTerraformsSummaryResponse {
...
export declare enum KubernetesPodKind {
    Pod = "Pod"
}
...
export declare enum KubernetesWorkloadKind {
 ...
 */
export interface ListFullTerraforms {
 ...
 */
export interface ListTerraforms {
    /** Structured query to filter Terraforms. */
    query?: TerraformQuery;
    /**
     * Retrieve more results by incrementing the page.
...
export declare enum ResourceRelationshipKind {
    Parent = "Parent",
    Child = "Child",
    RunsOn = "RunsOn",
    MemberOf = "MemberOf",
 ...
 */
export interface ReencryptSecrets {
    /** Report what would change without writing anything. */
    dry_run?: boolean;
}
export interface ReencryptSecretsResponse {
 ...
 * Response: [Update].
 */
export interface RenameTerraform {
 ...
 */
export interface RestartClusterWorkload {
    /** Id or name */
    cluster: string;
 ...
 */
export interface RollbackClusterWorkload {
    /** Id or name */
    cluster: string;
    /** `deployments`, `statefulsets` or `daemonsets`. */
    kind: string;
 ...
 */
export interface ScaleClusterWorkload {
    /** Id or name */
    cluster: string;
 ...
 * Response: [Log].
 */
export interface SearchClusterPodLog {
    /** Id or name */
    cluster: string;
    /** The pod's name. */
    pod: string;
 ...
 * Response: [Update]
 */
export interface UncordonClusterNode {
    /** Id or name */
    cluster: string;
    /** The node's name. */
    node: string;
 ...
 * occur from out of date local state.
 */
export interface UpdateTerraform {
...
export declare enum DockerProvider {
    Docker = "Docker"
}
...
export declare enum KubernetesProvider {
    Kubernetes = "Kubernetes"
}
export declare enum KubernetesResourceKind {
    Deployment = "Deployment",
    StatefulSet = "StatefulSet",
    DaemonSet = "DaemonSet",
    Job = "Job",
...
export type ReadRequest = {
    ...
    type: "GetTerraformActionState";
    params: GetTerraformActionState;
} | {
    type: "ListTerraforms";
    params: ListTerraforms;
} | {
    type: "ListFullTerraforms";
    params: ListFullTerraforms;
} | {
    ...
    type: "ListOrphanedObjects";
    params: ListOrphanedObjects;
} | {
    type: "ListNetworks";
    params: ListNetworks;
} | {
    ...
    type: "GetUpdateRevertToml";
    params: GetUpdateRevertToml;
} | {
    type: "ListUpdates";
    params: ListUpdates;
} | {
...
export type ResourceLocator = {
    type: "Komodo";
    params: ResourceTarget;
} | {
    type: "Docker";
    params: DockerResourceLocator;
} | {
    type: "Kubernetes";
    params: {
        cluster: string;
...
export declare enum SwarmProvider {
    Swarm = "Swarm"
}
...
export type WriteRequest = {
    ...
    type: "CopyTerraform";
    params: CopyTerraform;
} | {
    type: "DeleteTerraform";
    params: DeleteTerraform;
} | {
    type: "UpdateTerraform";
    params: UpdateTerraform;
} | {
    type: "RenameTerraform";
    params: RenameTerraform;
} | {
    type: "CreateSwarm";
    params: CreateSwarm;
} | {
    ...
    type: "ReencryptSecrets";
    params: ReencryptSecrets;
} | {
    type: "CreateVariable";
